...
<body>
        ...
        <div class="box">
            ...
            if(isset($_POST['rad-sub'])){
                            ...
                            if(isset($_POST['sid'])){
                                ...
                                $damn = "SELECT syn_stud_name, fac_report, stud_report, grade,syn_convenor_id, syn_con_name,comm_1,comm_2,comm_3,comm_4,comm1_name, comm2_name, comm3_name,comm4_name,attempt FROM synopsis WHERE syn_std_id = $sid and attempt=(SELECT MAX(attempt) FROM synopsis WHERE syn_std_id=$sid)";
            ...
            <input type="text" class="form-control" placeholder="<?php echo($ar[0]) ?>" readonly>
            <br>
            <form role="form" method="post" action="set_fculty.php">
                        <label>ALLOT FACULTY SUPERVISOR</label>
                        <input type="text" class="form-control" placeholder="<?php echo($ar[4]); echo(' '); echo($ar[5]); ?>" readonly>
                        <?php 
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo($ar[6]); echo(' '); echo($ar[10]); ?>" readonly>
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo($ar[7]);echo(' '); echo($ar[11]); ?>" readonly>
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo($ar[8]); echo(' '); echo($ar[12]); ?>" readonly>
                        ...
                        <input type="text" class="form-control" placeholder="<?php echo($ar[9]); echo(' '); echo($ar[13]); ?>" readonly>
    ...
    <!-- Previous attempts of the student-->
    
    <?php
        $damn1 = "SELECT syn_stud_name, fac_report, grade, stud_report, syn_convenor_id FROM synopsis WHERE syn_std_id = $sid AND attempt< (SELECT MAX(attempt) FROM synopsis WHERE syn_std_id=$sid)";
