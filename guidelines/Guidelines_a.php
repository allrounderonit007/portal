...
<body>
    ...
    <div class="container">
        <div class="box">
            <label>Upload Files for student</label>
            <?php
                
                if (count(glob("../admin upload/student/*")) === 0 ){
                    ?>
                <form action="upload_s.php" method="post" enctype="multipart/form-data">
                        ...
                        {
                         ?>
                               <label>The File should be in PDF format"</label>
                               <?php
                        }
                        ?>
                <?php
                        ...
                        ?>
                            <br>
                            <label>Upload Files for Faculty</label>
            <?php
                
                if (count(glob("../admin upload/faculty/*")) === 0 ){
                    ?>
                <form action="upload_f.php" method="post" enctype="multipart/form-data">
                        ...
                        else if(isset($_GET['failf']))
                        {
                         ?>
                               <label>Problem While File Uploading !</label>
                               <?php
                        }
                        else if(isset($_GET['existsf'])){
                            ?>
                               <label>Filename exists. Upload new file.</label>
                               <?php
                        }
