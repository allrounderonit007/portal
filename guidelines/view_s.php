...
<body>
    ...
    <div class="container">
        <div class="box">
            <label>View Student Files</label><a href="Guidelines_a.php">Upload new files</a></label>
                <br>
                <?php
                
                echo("<a href=\"../admin upload/student/\""); 
                //echo ($take2[0]);
                echo("\"target=\"_blank\">View file</a>");
                ?>
                <br>
                
            <label>View Faculty Files</label><a href="Guidelines_a.php">Upload new files</a></label>
                <br>
                <?php
                
                echo("<a href=\"../admin upload/faculty/\""); 
                //echo ($take2[0]);
                echo("\"target=\"_blank\">View file</a>");
                ?>    
        </div>
