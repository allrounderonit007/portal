...
<body>
    ...
    if(isset($_POST['editsem'])){
        ...
        $ring = connection();
        $ding = "SELECT stud_name,grade1, grade2, grade3, grade4, grade5, stud_report, f_report FROM rps WHERE s_rps_id=$u_id AND rps_semester = $sem";
        ...
        <div class="box">
            ...
            <?php
                        if($entry1[6]=="NA"){
                            ...
                            echo("<br><a href=\"../rps_uploads/student/$u_id/");
                            echo($entry1[6]);
            ...
            <?php
                        if($entry1[7]=="NA"){
                            ...
                            echo("<br><a href=\"../rps_uploads/faculty/$u_id/");
                            echo($entry1[7]);
                            echo("\"target=\"_blank\">View File</a><br>");
                        }
                        ?>
